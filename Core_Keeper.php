...
<?php
   ...
   $resultado = mysqli_query($conexion, "SELECT * FROM juegos WHERE ID = 16");
...
<article class="juegos">
 ...
 <nav class = "navsl">
    ...
    <div>
        ...
        <br>
        <h4>FECHA DE LANZAMIENTO: 8 MAR 2022
        <br>
        <br>
        DESARROLLADOR: <a href="https://pugstorm.eu/" target="_blank">Pugstorm</a> 
        <br>
        EDITOR: <a href="https://fireshinegames.co.uk/" target="_blank">Fireshine Games</a>  
        </h4>
    </div>
