...
<?php
   ...
   $resultado_2 = mysqli_query($conexion, "SELECT * FROM desarrollador WHERE ID = 10");
   $variable_2 = mysqli_fetch_assoc($resultado_2);

   $resultado_3 = mysqli_query($conexion, "SELECT * FROM editor WHERE ID = 10");
...
<article class="juegos">
 ...
 <nav class = "navsl">
    ...
    <div class="info">
        ...
        <br>
        <br>
        DESARROLLADOR: <a href="https://www.residentevil.com/re4/es/" target="_blank"><?php echo $variable_2["Desarrollador"]; ?></a> 
        <br>
