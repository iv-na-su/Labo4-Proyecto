...
<?php
   ...
   $resultado = mysqli_query($conexion, "SELECT * FROM juegos WHERE ID = 14");
...
<article class="juegos">
 ...
 <nav class = "navsl">
    ...
    <div>
        ...
        <br>
        <h4>FECHA DE LANZAMIENTO: 8 JUN 2023
        <br>
        <br>
        DESARROLLADOR: <a href="https://semiwork.se/" target="_blank">semiwork</a> 
        <br>
        EDITOR: <a href="https://semiwork.se/" target="_blank">semiwork</a>  
        </h4>
    </div>
