...
<?php
   ...
   $resultado_3 = mysqli_query($conexion, "SELECT * FROM desarrollador WHERE ID = 11");
...
<article class="juegos">
 ...
 <nav class = "navsl">
    ...
    <div>
        ...
        <br>
        <br>
        DESARROLLADOR: <a href="https://frictionalgames.com/" target="_blank"><?php echo $variable_3["Desarrollador"]; ?></a> 
        <br>
