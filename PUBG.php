...
<?php
   ...
   $resultado = mysqli_query($conexion, "SELECT * FROM juegos WHERE ID = 5");
...
<article class="juegos">
 ...
 <nav class = "navsl">
    ...
    <div>
        ...
        <br>
        <h4>FECHA DE LANZAMIENTO: 21 DIC 2017
        <br>
        <br>
        DESARROLLADOR: <a href="https://krafton.com/en/" target="_blank">KRAFTON, Inc.</a> 
        <br>
        EDITOR: <a href="https://krafton.com/en/" target="_blank">KRAFTON, Inc.</a>  
        </h4>
    </div>
