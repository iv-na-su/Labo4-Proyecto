...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2023 a las 00:17:35
...
(22, 'SOUTH PARK: THE STICK OF TRUTH', '2014-03-04', 7, 22, 20, 'De entre los mortíferos campos de batalla del patio de recreo de cuarto curso, un joven héroe se alzará, destinado a ser el salvador de South Park. De los creadores de South Park, Trey Parker y Matt Stone, llega una épica aventura para llegar a ser... guay. Presentamos: South Park™: The Stick of Truth™.', 'ADe entre los mortíferos campos de batalla del patio de recreo de cuarto curso, un joven héroe se alzará, destinado a ser el salvador de South Park. De los creadores de South Park, Trey Parker y Matt Stone, llega una épica aventura para llegar a ser... guay. Presentamos: South Park™: The Stick of Truth™.<br> Comienzas como el niño nuevo del pueblo enfrentándote a un escalofriante reto: hacer amigos. A la vez que tú comienzas esta aventura, los chicos de South Park están envueltos en un enorme juego de rol por toda la ciudad, conjurando hechizos imaginarios y blandiendo espadas de juguete. Con el tiempo, este simple juego de niños se tornará en una batalla entre el bien y el mal que amenazará con consumir el mundo.<br> Equípate con armas de leyenda para derrotar a hombres cangrejo, gnomos de los calzoncillos, hippies y otras fuerzas del mal. Descubre el Stick of Truth y gánate tu sitio como amigo al lado de Stan, Kyle, Cartman y Kenny. Triunfa y serás el salvador de South Park, consolidando tu estatus social en la escuela de primaria de South Park. Fracasa y serás para siempre conocido como... un perdedor.<br>  <br><br><br> Características principales:<br><br>  ○ La experiencia South Park definitiva<br> Escrito y doblado por Trey Parker y Matt Stone, The Stick of Truth lleva su humor único al videojuego. <br><br> ○ Una épica aventura para llegar a ser... guay<br> Gánate tu sitio junto Stan, Kyle, Cartman y Kenny y únete a ellos en una histérica aventura para salvar South Park. <br><br> ○ Amigos con beneficios<br> Recluta a personajes clásicos de South Park para tu causa. <br><br> ○ Combate intenso<br> Ármate hasta los dientes con todo un arsenal de armas mágicas y místicas armaduras. <br><br> ○ Personalización marca South Park<br> Retrátate a ti mismo en South Park con cosa de un billón de combinaciones entre personajes, ropa y armas.', 'MÍNIMO: <br><br> SO: WindowsXP SP3, Windows Vista SP2, Windows 8 (both 32/64bit versions)<br> Procesador: Intel Pentium Dual-Core E2180 @ 2.0 GHz or AMD Athlon64 X2 3800+ @ 2.0 GHz<br> Memoria: 2 GB GB de RAM<br> Gráficos: nVidia GeForce 8800GT or AMD Radeon HD2600XT (512MB VRAM with Shader Model 4.0 or higher)<br> DirectX: Versión 9.0c<br> Almacenamiento: 6 GB de espacio disponible<br> Tarjeta de sonido: DirectX Compatible Sound Card with latest drivers<br> Notas adicionales: Originally released for Windows 7, the game can be played on Windows 10 and Windows 11 OS <br><br> <br><br> RECOMENDADO: <br><br> SO: Windows 7<br> Procesador: Core i5 750 a 2.67 GHz o equivalente<br> Memoria: 4 GB de RAM<br> Gráficos: ATI Radeon HD 4870 o nVidia GTX 260<br> DirectX: Versión 9.0c<br> Almacenamiento: 6 GB de espacio disponible<br> Tarjeta de sonido: DirectX Compatible Sound Card with latest drivers<br> Notas adicionales: Originally released for Windows 7, the game can be played on Windows 10 and Windows 11 OS', 'images/Capturas/South_Park_TSOT/South_Park_TSOT'),
(23, 'WWE 2K23', '2023-03-16', 8, 23, 21, 'WWE 2K23 es Aún Más Fuerte con características ampliadas, magníficos gráficos y un profundo plantel de Superestrellas y Leyendas de la WWE. Vuelve 2K Showcase, un documental deportivo interactivo centrado en los 20 años de carrera de John Cena, y por fin llega WarGames.', '¡Características ampliadas, magníficos gráficos y la experiencia WWE definitiva. Sube al ring con un gran elenco de superestrellas y leyendas de la WWE, como Roman Reigns, \"American Nightmare\" Cody Rhodes, Ronda Rousey, Brock Lesnar, \"Stone Cold\" Steve Austin y muchos más! 2K SHOWCASE: DOCUMENTAL DEPORTIVO INTERACTIVO Recorre los momentos clave y los rivales más duros de los 20 años de carrera de John Cena en la WWE. Y, por primera vez en la franquicia, adopta el papel de cada uno de sus grandes oponentes -algunos de los más grandes de la WWE de todos los tiempos- para acabar con Mr. Hustle, Loyalty, y Respect. HORA DE COMBATIR El combate WarGame rebosante de acción y aclamado por los seguidores ya llega a WWE 2K23. Prepárate para un caos multijugador de 3 contra 3 y 4 contra 4 dentro de dos cuadriláteros uno al lado del otro, ¡rodeados por una jaula de acero doble! TU ESPECTÁCULO, TUS ELECCIONES Con MyGM, toma las riendas de un espectáculo semanal y compite contra managers rivales por la supremacía de la marca. Ahora con más GMs entre los que elegir, opciones de espectáculo adicionales, múltiples Temporadas, cartas de combate ampliadas y más tipos de combate para hasta 4 jugadores. TÚ TIENES TODAS LAS CARTAS Colecciona y mejora cartas de Superestrellas y Leyendas de la WWE para crear la facción definitiva y competir por el dominio mundial en Mi FACCIÓN, ¡ahora con multijugador online! DEFINE TU FUTURO EN Mi LEYENDA Atraviesa el telón de tu debut en la WWE y da forma a tu carrera como Superestrella de la WWE con las decisiones que tomes en el camino a través de distintas historias: The Lock y El legado. EL UNIVERSO ES TODO TUYO El modo Universo WWE es el sandbox definitivo que te pone al mando de la WWE, desde los rosters de Superstars, feudos, campeones, shows semanales, ¡y mucho más!  *Capacidad local para un máximo de 4 jugadores / Capacidad online para un máximo de 8 jugadores', 'MÍNIMO: Requiere un procesador y un sistema operativo de 64 bits SO: Windows 10 64-bit Procesador: Intel Core i5-3550 / AMD FX 8150 Memoria: 8 GB de RAM Gráficos: GeForce GTX 1060 / Radeon RX 480 DirectX: Versión 12 Almacenamiento: 80 GB de espacio disponible Tarjeta de sonido: DirectX 9.0c compatible sound card Notas adicionales: SSD recommended, AVX - Compatible processor RECOMENDADO: Requiere un procesador y un sistema operativo de 64 bits SO: Windows 10 64-bit Procesador: Intel i7-4790 / AMD FX 8350 Memoria: 16 GB de RAM Gráficos: GeForce GTX 1070 / Radeon RX 580 DirectX: Versión 12 Almacenamiento: 80 GB de espacio disponible Tarjeta de sonido: DirectX 9.0c compatible sound card Notas adicionales: SSD recommended, AVX - Compatible processor', 'images/Capturas/WWE_2K23/WWE_2K23');
